...
| `GET /admin/logs/:operationId/payload` | Decrypt a retained forensic sample. Requires `payloads:read` (master, owner, or admin) and is audit logged; returns 404 when no sample exists. |
