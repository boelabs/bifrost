...
In Spanish prose, prefer "inteligencia artificial" in full. Use "IA" only when an abbreviation
is necessary, and preserve official product names such as Vercel AI SDK.
