...
Parameter policy controls how Bifrost handles a request field that a deployment does not support.
The catalog declares support per model; the router setting chooses whether to drop the field,
reject the request, or pass it through.
